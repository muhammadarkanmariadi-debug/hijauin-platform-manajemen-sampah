...
return [
    ...
    'documentations' => [
        'default' => [
            'api' => [
                'title' => 'Hijauin v2 API Documentation - Platform Manajemen Bank Sampah',
            ],
        ...
        'securityDefinitions' => [
            'securitySchemes' => [
                'sanctum' => [
                    ...
                    'scheme' => 'bearer',
                    'bearerFormat' => 'JWT',
                    'description' => 'Masukkan Bearer Token hasil autentikasi login atau register (contoh: 1|xxxxxxxx...)',
                ],
            ],
            'security' => [
                [
